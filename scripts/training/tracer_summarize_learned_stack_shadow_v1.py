...
def main():
    ...
    ap.add_argument("--glob", default="data/shadow_logs/learned_stack_shadow_*.csv")
    ap.add_argument("--out-json", default="data/shadow_logs/learned_stack_shadow_summary_v1.json")
    args = ap.parse_args()
    ...
    print(f"[TRACER] wrote shadow summary: {out}")
