...
TARGET_ACTIONS = {
    ...
    "tracer_sponge_firm_flat": {
        "balanced": "sponge_v8c_far_fast_early_stop",
        "reach": "sponge_v8b_probe_reach_fast",
        "stability": "sponge_v8_anchor_mix_top3",
    },
}
...
def main():
    ...
    ap.add_argument("--out-dir", default="data/phase_b_theta_residual_actor_v1_multimode")
    args = ap.parse_args()
    ...
    for r in rollouts:
        ...
        for mode in TARGET_MODES:
            ...
            rows.append({
                "schema": "phase_b_theta_residual_actor_seed_v1_multimode",
                "world": world,
                "target_mode": mode,
    ...
    write_jsonl(out_dir / "phase_b_theta_residual_actor_seed_v1_multimode.jsonl", rows)
    ...
    report = {
        "schema": "phase_b_theta_residual_actor_dataset_report_v1_multimode",
        "rows": len(rows),
    ...
    with open(out_dir / "phase_b_theta_residual_actor_dataset_report_v1_multimode.json", "w") as f:
        json.dump(report, f, indent=2, sort_keys=True)

    lines = []
    lines.append("# Phase-B θ Residual Actor Seed Dataset v1 Multimode")
    lines.append("")
    ...
    md = "\n".join(lines) + "\n"
    with open(out_dir / "phase_b_theta_residual_actor_dataset_report_v1_multimode.md", "w") as f:
        f.write(md)

    print(md)
    print("[wrote]", out_dir / "phase_b_theta_residual_actor_seed_v1_multimode.jsonl")
