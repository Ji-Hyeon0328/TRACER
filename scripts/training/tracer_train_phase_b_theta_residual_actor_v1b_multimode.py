...
def main():
    ...
    ap.add_argument("--dataset", default="data/phase_b_theta_residual_actor_v1b_multimode/phase_b_theta_residual_actor_seed_v1b_multimode.jsonl")
    ap.add_argument("--out-dir", default="artifacts/phase_b_theta_residual_actor_v1b_multimode")
    ap.add_argument("--report-json", default="reports/phase_b_theta_residual_actor_v1b_multimode.json")
    ap.add_argument("--report-md", default="reports/phase_b_theta_residual_actor_v1b_multimode.md")
    ...
    model = ResidualActorV1b(input_dim=X_train.shape[1])
    ...
    ckpt = {
        "schema": "phase_b_theta_residual_actor_v1b_multimode",
    ...
    report = {
        "schema": "phase_b_theta_residual_actor_train_report_v1b_multimode",
    ...
    lines = []
    lines.append("# Phase-B θ Residual Actor v1b Multimode")
    lines.append("")
