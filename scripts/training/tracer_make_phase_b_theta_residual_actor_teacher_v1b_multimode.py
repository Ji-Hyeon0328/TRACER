...
class ResidualActorV1b(nn.Module):
...
def add_action_to_world(data, world, action_name, theta, meta):
    ...
    world_obj["actions"].append({
        ...
        "theta_action": theta,
        "source": "theta_residual_actor_v1b_multimode",
        **meta,
    })
...
def main():
    ...
    ap.add_argument("--teacher-out", default="configs/phase_b_theta_residual_actor_v1b_multimode/ppo_warmstart_teacher_table_theta_residual_actor_v1b_multimode.json")
    ap.add_argument("--model", default="artifacts/phase_b_theta_residual_actor_v1b_multimode/model.pt")
    ...
    model = ResidualActorV1b(input_dim=int(ckpt["input_dim"]))
    model.load_state_dict(ckpt["model_state_dict"])
    model.eval()

    # Same-anchor multimode test. This checks whether target_mode truly changes theta.
    specs = [
        ("earth", "trot_solid_fast", "balanced", "theta_actor_v1b_earth_balanced_from_trot_solid_fast"),
        ("earth", "trot_mid", "reach", "theta_actor_v1b_earth_reach_from_trot_mid"),
        ("earth", "trot_solid_fast", "stability", "theta_actor_v1b_earth_stability_from_trot_solid_fast"),

        ("stairs_single", "trot_mid", "balanced", "theta_actor_v1b_stairs_balanced_from_trot_mid"),
        ("stairs_single", "trot_mid", "reach", "theta_actor_v1b_stairs_reach_from_trot_mid"),
        ("stairs_single", "trot_solid_fast", "stability", "theta_actor_v1b_stairs_stability_from_trot_solid_fast"),

        ("tracer_sponge_firm_flat", "trot_soft_mid_clear", "balanced", "theta_actor_v1b_sponge_balanced_from_trot_soft_mid_clear"),
        ("tracer_sponge_firm_flat", "trot_soft_mid_clear", "reach", "theta_actor_v1b_sponge_reach_from_trot_soft_mid_clear"),
        ("tracer_sponge_firm_flat", "trot_soft_mid_clear", "stability", "theta_actor_v1b_sponge_stability_from_trot_soft_mid_clear"),
    ]

    print("Generating v1b multimode residual actor actions:")
