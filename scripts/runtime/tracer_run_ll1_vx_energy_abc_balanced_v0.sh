...
RUN_ROOT="${TRACER_VX_ABC_RUN_ROOT:-$ROOT/logs/revalidation_vx_energy_abc_${TS}}"
...
echo
echo "===== VX ENERGY A/B/C CAMPAIGN COMPLETE ====="
echo "RUN_ROOT=$RUN_ROOT"
...
echo "[PASS] selected VX campaign runs complete"
