...
class SupervisedStackServer:
    def __init__(self, args):
        ...
        print("[TRACER] supervised stack UDP server v3")
    ...
    def handle(self, req: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resp = {
            "ok": True,
            "server": "tracer_supervised_stack_udp_server_v3",
            "n": self.n,
...
def main():
    ...
    ap.add_argument("--ram-model", default="artifacts/ram_shadow_v2/ram_shadow_v2.pt")
