...
def load_objective(path: str, device):
    b = torch.load(path, map_location="cpu")
    m = ObjectiveSelectorMLP(int(b["input_dim"]), int(b.get("hidden_dim", 64)))
...
class SupervisedStackServer:
    def __init__(self, args):
        ...
        print("[TRACER] supervised stack UDP server v1")
    ...
    def handle(self, req: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resp = {
            "ok": True,
            "server": "tracer_supervised_stack_udp_server_v1",
            "n": self.n,
...
def main():
    ...
    ap.add_argument("--port", type=int, default=50410)
