...
RUN_ROOT="${TRACER_PHASE_B_ADAPTIVE_RUN_ROOT:-$ROOT/artifacts/phase_b_adaptive_selected_episodes_v2_${STAMP}}"
mkdir -p "$RUN_ROOT"

SUMMARY_CSV="$RUN_ROOT/adaptive_summary.csv"

echo "[TRACER] Phase-B adaptive selected episodes v2"
...
for EP in $(seq 1 "$NUM_EPISODES"); do
  ...
  echo
  echo "============================================================"
  echo "[TRACER] adaptive v2 episode $EP/$NUM_EPISODES"
...
echo
echo "============================================================"
echo "[TRACER] adaptive v2 summary"
echo "============================================================"
