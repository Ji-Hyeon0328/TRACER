...
def main():
    ...
    ap.add_argument(
        ...
        default=(
            "results/icra27/"
            "m7_ppo_beta_conditioned_tracer_cost_v3_v0"
        ),
    )
    ...
    summary = {
        "schema":
            "icra27_m7_ppo_beta_conditioned_v2",
    ...
    print("=" * 88)
    print(
        "ICRA27 M7 BETA-CONDITIONED MULTI-TERRAIN PPO / TRACER-COST-V3"
    )
    print("=" * 88)
    ...
    print(
        ...
        "PPO tracer-cost-v3 training: PASS"
    )
    print("=" * 88)
