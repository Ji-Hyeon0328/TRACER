...
OUT_DIR = (
    ROOT
    / "results/icra27"
    / "os_t6p10a_oracle_eta_semantic_transfer_v1"
)
...
def write_csv(path, rows):
    ...
    # Rows such as the balanced eta summary and
    # biased eta summaries intentionally have
    # different optional diagnostic fields.
    # Build the union of keys in deterministic
...
def main():
    ...
    manifest = {
        "schema":
            "icra27_os_t6p10a_oracle_eta_semantic_transfer_v1",
