...
OUT_DIR = (
    ...
    / "results"
    / "icra27"
    / "os_t4p5f_lrhalf_checkpoint_sweep_v0"
    / "train9"
)
...
def summarize_candidate(rows):
    ...
    gate = {
        ...
        # Hard prerequisite added after the u35 diagnostic
        # exposed cost-improving but unsuccessful trajectories.
        # This rule is frozen BEFORE evaluating this new run.
        "feasibility_36_of_36":
            success_count == len(rows) == 36,
    }
...
def main():
    ...
    print("=" * 112)
    print(
        "ICRA27 OS-T4.5f LR-HALF TRAIN-ONLY "
    ...
    manifest = {
        "schema":
            "icra27_os_t4p5f_lrhalf_checkpoint_sweep_v0",
