...
ROUGH_PERLIN_TRAIN_CALIBRATION_SEEDS = (
    13,
    7,
    15,
    0,
...
def seed_bank(
    ...
    # IMPORTANT:
    # Energy-scale calibration must use training terrain
    # realizations only. Validation/test Perlin seeds are
    # intentionally excluded from normalization design.
...
def main():
    ...
    (
        ...
        json.dumps(
            {
                "schema":
                    "icra27_m7_action_energy_traincal_v1",
