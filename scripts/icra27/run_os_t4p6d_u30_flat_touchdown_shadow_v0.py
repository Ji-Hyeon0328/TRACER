...
def main():
    ...
    #
    # k6f uses the tracer_cost_v3 checkpoint/evaluation contract,
    ...
    if (
        ...
        raise RuntimeError(
            "k6f reward-mode promotion failed."
        )
    ...
    def lockstep_ctor(
        ...
        **kwargs,
        ...
        if not bool(
            ...
            raise RuntimeError(
                "k6f environment is not lockstep."
            )
        ...
        if int(
            ...
            raise RuntimeError(
                "k6f requires 100 physics ticks."
            )
    ...
    print(
        "[ICRA27] OS-T4.6d "
        "u30 k11 per-foot 500 Hz trace: PASS"
    )
    print("=" * 112)
