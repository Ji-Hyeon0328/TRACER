...
OUT_DIR = (
    ROOT
    / "results/icra27"
    / "os_t5p5a_oracle_context_descriptor_v0"
)
...
def main():
    ...
    # Global-hfield uniqueness is a provenance
    ...
    rough_manifest = {
        "schema":
            "icra27_os_t5p5a_rough_geometry_manifest_v0",
    ...
    contract = {
        "schema":
            "icra27_os_t5p5a_oracle_context_descriptor_v0",
