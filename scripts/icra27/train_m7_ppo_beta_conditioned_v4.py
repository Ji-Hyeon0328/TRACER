...
def main():
    ...
    ap.add_argument(
        ...
        default=(
            "results/icra27/"
            "m7_ppo_beta_conditioned_tracer_cost_v4_lr1p5e4_v0"
        ),
    )
    ...
    print("=" * 88)
    print(
        "ICRA27 M7 BETA-CONDITIONED MULTI-TERRAIN PPO / TRACER-COST-V4 / LR-1.5E-4"
    )
    print("=" * 88)
    ...
    print(
        ...
        "PPO tracer-cost-v4 LR-half training: PASS"
    )
    print("=" * 88)
