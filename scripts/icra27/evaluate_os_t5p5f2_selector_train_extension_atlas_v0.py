...
def main():
    ...
    plan = {
        "schema":
            "icra27_os_t5p5f2_selector_train_extension_atlas_plan_v0",
    ...
    manifest = {
        "schema":
            "icra27_os_t5p5f2_selector_train_extension_atlas_v0",
