...
"""
SLR-HL-adapted-v1 reward for ICRA27 Phase 1.5.
...
REWARD_SCHEMA = "icra27_slr_hl_adapted_v1"
...
class SLRHLReward:
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "slr_base_height_target_m":
                BASE_HEIGHT_TARGET_M,
...
def compute_slr_hl_reward(
    *,
    ...
    base_height_target_m: float = (
        BASE_HEIGHT_TARGET_M
    ),
) -> SLRHLReward:
    """
    Compute SLR-HL-adapted-v1.
