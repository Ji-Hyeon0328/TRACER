...
class PhaseBLL1BankJ7Mapper(Node):
    """
    ...
    Every v0 bank action remains within:
      |delta vx| <= 0.025 m/s
      |delta clearance| <= 0.010 m
      |delta yaw| <= 0.020 rad/s
    """

    def __init__(self) -> None:
        super().__init__("tracer_phase_b_ll1_bank_j7_mapper_node_v0")
    ...
    def _hold_references(
        ...
        theta = [0.0] * 9
        theta[0] = float(self.selected_action_id)
