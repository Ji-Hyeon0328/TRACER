...
public:
    ...
    // ROS-free adapter path:
    // The original resetFromROSParam(ros::NodeHandle&) is intentionally removed.
    // Use reset() defaults and override fields directly from TRACER parameters if needed.
