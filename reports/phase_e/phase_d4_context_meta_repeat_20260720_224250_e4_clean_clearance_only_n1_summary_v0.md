...
- manifest: `reports/phase_d4_context_meta_repeat_20260720_224250_manifest.tsv`
- n: `1`
- success_rate: `1.000`
- goal_rate: `1.000`
- startup_failed_rate: `0.000`
- out_lane_rate: `0.000`
- hold_drift_mean: `0.025000000000000355`

## Individual rollouts

| trial | hold_vx | success | goal | startup_failed | out_lane | final_x | final_y | max_x | max_abs_y | mean_abs_y | hold_drift | final_context |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 0.025 | True | True | False | False | 8.145 | -0.117 | 8.170 | 0.352 | 0.148 | 0.025 | goal_flat |
