...
- manifest: `reports/phase_d4_context_meta_repeat_20260720_115800_manifest.tsv`
- n: `1`
- success_rate: `1.000`
- goal_rate: `1.000`
- startup_failed_rate: `0.000`
- out_lane_rate: `0.000`
- hold_drift_mean: `0.03500000000000014`

## Individual rollouts

| trial | hold_vx | success | goal | startup_failed | out_lane | final_x | final_y | max_x | max_abs_y | mean_abs_y | hold_drift | final_context |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | 0.025 | True | True | False | False | 8.070 | 0.136 | 8.105 | 0.190 | 0.093 | 0.035 | goal_flat |
